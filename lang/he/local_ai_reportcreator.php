...
$string['ai_reportcreator:view'] = 'צפייה בדוחות AI';
...
$string['event:connection_tested'] = 'נבדק חיבור ל-middleware';
$string['event:report_created'] = 'דוח נוצר';
$string['event:report_deleted'] = 'דוח נמחק';
$string['event:report_exported'] = 'דוח יוצא';
$string['event:report_generation_failed'] = 'יצירת הדוח נכשלה';
$string['event:report_updated'] = 'דוח עודכן';
$string['event:report_viewed'] = 'דוח נצפה';
