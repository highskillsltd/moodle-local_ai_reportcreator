...
$string['ai_reportcreator:view'] = 'View AI reports';
...
$string['event:connection_tested'] = 'Middleware connection tested';
$string['event:report_created'] = 'Report created';
$string['event:report_deleted'] = 'Report deleted';
$string['event:report_exported'] = 'Report exported';
$string['event:report_generation_failed'] = 'Report generation failed';
$string['event:report_updated'] = 'Report updated';
